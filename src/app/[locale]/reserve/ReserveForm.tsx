    ...
    >
      <div>
        <label htmlFor="reserve-name" className={labelClass}>
          {t("nameLabel")} <span aria-hidden="true" className="text-[var(--color-terracotta-500)]">*</span>
        </label>
        <input
          id="reserve-name"
          type="text"
      ...
      <div>
        <label htmlFor="reserve-items" className={labelClass}>
          {t("itemsLabel")} <span aria-hidden="true" className="text-[var(--color-terracotta-500)]">*</span>
        </label>
        <textarea
          id="reserve-items"
          required
